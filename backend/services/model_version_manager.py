...
class ModelVersionManager:
    ...
    def register_version(self, version: str, trained_date: str, accuracy: float, source: str) -> ModelVersion:
    ...
    def get_version_history(self) -> List[Dict]:
        ...
        return [v.to_dict() for v in sorted(self.versions, key=lambda x: x.created_at, reverse=True)]
