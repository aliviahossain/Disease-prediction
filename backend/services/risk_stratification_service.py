...
def stratify_risk(
    ...
    # Recommendations
    recommendations = {
        RiskLevel.CRITICAL: ["Immediate medical consultation required", "Consider hospitalization"],
        RiskLevel.HIGH: ["Schedule urgent appointment with specialist", "Monitor symptoms closely"],
        RiskLevel.MEDIUM: ["Schedule appointment with healthcare provider", "Lifestyle modifications recommended"],
        RiskLevel.LOW: ["Continue regular health checkups", "Maintain healthy lifestyle"]
    }
